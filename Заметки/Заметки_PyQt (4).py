...
from PyQt5.QtWidgets import QApplication, QMainWindow, QDialog, QVBoxLayout, QHBoxLayout, QDateTimeEdit, QPushButton
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_notice.setStyleSheet("\n"
                                        "background-color: qlineargradient(spread:pad, x1:0.5, y1:1, x2:0.5, y2:0, stop:0 rgba(255, 255, 255, 0.7), stop:0.810945 rgba(255, 255, 255, 0.8), stop:0.825871 rgba(146, 255, 216, 1));")
        ...
        self.label_notice.setGeometry(QtCore.QRect(120, 0, 400, 60))
        ...
        self.button_point = QtWidgets.QPushButton(self.frame_notice)
        self.button_point.setGeometry(QtCore.QRect(460, 320, 130, 40))
        font = QtGui.QFont("Days One", 10)
        self.button_point.setFont(font)
        self.button_point.setStyleSheet("background-color: rgba(105, 255, 201, 1);\n"
                                        "color: rgb(255, 255, 255);\n"
                                        "border-radius: 10px;")
        self.button_point.setObjectName("button_del_2")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_point.setText(_translate("MainWindow", "Задать"))
